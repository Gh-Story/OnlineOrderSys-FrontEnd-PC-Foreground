	...
	<div class='taskManage'>
	  ...
	  <div class="row" v-for="item in alltask">
		  <div class="row_i" v-for="task in item">
			...
			<div style="margin-left: 25%;margin-top: 20%;color:white;">
				<el-row>{{task.name}}</el-row>
				<el-row>今日下{{task.need}}单</el-row>
				<el-row>奖励：{{task.redPacket}}</el-row>
			</div>
		  </div>
	  </div>
	  ...
	  <div class="row" v-for="item in allmytask">
	  		  <div class="row_i" v-for="task in item">
	  			...
	  			<div style="margin-left: 25%;margin-top: 20%;color:white;">
	  				<el-row>{{task.name}}</el-row>
	  				<el-row>今日下{{task.need}}单</el-row>
					<el-row>已完成{{task.finished}}单</el-row>
	  				<el-row>奖励：{{task.redPacket}}</el-row>
	  			</div>
	  		  </div>
	  </div>
